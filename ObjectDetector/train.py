...
from dataset.figclsdataset import *
...
def parse_args():
    ...
    parser.add_argument('--checkpoint_interval', type=int,
                        default=10, help='interval between saving checkpoints')
...
def main():
    ...
    dataset = FigClsDataset(model_type=cfg['MODEL']['TYPE'],
                  data_dir='./ME_dataset/training_data/JPEGImages',
                  img_size=cfg['TRAIN']['IMGSIZE'],
                  augmentation=cfg['AUGMENTATION'],
                  anno_dir = './ME_dataset/training_data/annotation/',
                  name='pipeline',
                  debug=False)
