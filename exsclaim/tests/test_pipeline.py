...
class TestNatureFull(unittest.TestCase):
    ...
    def test_full_run(self):
        ...
        search_url_1 = "https://www.nature.com/search?q=Ag%20nanoparticle&"
        search_url_2 = (
            "https://www.nature.com/search?q=Ag%20nanoparticle&"
            "date_range=&journal=&order=relevance"
        )
        ...
        accepted_difference = {
            "values_changed": {
                (
                    "root['s41467-018-06211-3_fig5.jpg']"
                    "['master_images'][0]['caption'][0]"
                ): {
                    "new_value": (
                        "Precious metal dissolution tests in aluminum – air flow "
                        "batteries (AAFBs) using the SMNp and Pt/C with 6\u2009M "
                        "KOH electrolyte after 6 \u2009 h of discharging at "
                        "50\u2009mA\u2009cm−2"
                    ),
                    "old_value": "c, d",
                }
