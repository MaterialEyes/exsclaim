...
from exsclaim.utilities.postgres import (
    initialize_database,
    modify_database_configuration,
)
...
def main():
    ...
    view_parser.add_argument(
        ...
        "-c",
        type=str,
        default=str(current_file.parent / "database.ini"),
        help=(
    ...
    view_parser = subparsers.add_parser(
        "test", description=("Test the exsclaim pipeline")
    )
    ...
    if args.command == "run":
        ...
        os.environ.setdefault(
            "DJANGO_SETTINGS_MODULE", "exsclaim.ui.exsclaim_gui.settings"
        )
